        ...
        <div class="row flex-grow">
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              ...
              <form class="pt-3" method="post" action="<?php echo base_url('Login/Userlogin'); ?>">
                ...
                <div class="my-3">
                  ...
                  <!-- <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="<?=base_url()?>Dashboard">LOGIN</a> -->
                </div>
