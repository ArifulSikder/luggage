          ...
          <div class="navbar-menu-wrapper d-flex align-items-center justify-content-between">
                  ...
                  <?php foreach ($notifications as $notification): ?>
                    <a class="dropdown-item preview-item">
                      ...
                      <div class="preview-item-content">
                        <h6 class="preview-subject font-weight-normal"><?= $notification['notification_text'] ?></h6>
                        <p class="font-weight-light small-text mb-0 text-muted">
                          <?= date('M j, Y H:i:s', strtotime($notification['notification_datetime'])) ?>
                        </p>
                      </div>
                    </a>
                  <?php endforeach; ?>
              ...
              <!-- <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                  ...
                  <a class="dropdown-item preview-item">
                    ...
                    <div class="preview-item-content flex-grow">
                        <h6 class="preview-subject ellipsis font-weight-normal"> <?= $this->session->userdata('full_name') ?>
                        </h6>
                        <p class="font-weight-light small-text text-muted mb-0">
            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item dropdown  d-lg-flex d-none">
                <a href="<?=base_url()?>Bookings"><button type="button" class="btn btn-inverse-primary btn-sm">Bookings </button></a>
              </li>
              <li class="nav-item dropdown d-lg-flex d-none">
              ...
              <li class="nav-item nav-profile dropdown">
                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
                  <span class="nav-profile-name"><?= $this->session->userdata('full_name') ?></span>
      ...
      <nav class="bottom-navbar">
        <div class="container">
          <ul class="nav page-navigation">
            ...
            <li class="nav-item">
              <a href="<?= base_url() ?>Myhub" class="nav-link">
                <i class="mdi mdi-cube-outline menu-icon"></i>
                <span class="menu-title">My Hub</span>
