...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact" dir="ltr"
    data-theme="theme-default" data-assets-path="{{ asset('assets') }}/assets/"
                    ...
                    <div class="text-center" style="text-align: center;">
                        <div class="card-body text-center ml-2 d-block"
                            ...
                            <div class="mx-auto my-6"
                                ...
                                <img src="{{ asset('assets') }}/assets/img/avatars/3.png" alt="Avatar Image"
                                    ...
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img class="card-img card-img-left"
                                                src="{{ asset('assets') }}/assets/img/active_orders.jpg"
                                                alt="Card image" />
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body">
